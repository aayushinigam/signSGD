"""
MNIST_signSGD.py - signSGD on Neural Nets
...
cost_list_signSGD, W1, b1 = gradient_descent(W_signSGD, b_signSGD, dropout_rate=.7, lbd =.03, learning_rate=0.0008, signSGD = True)
if(rank==0):
...
cost_list_SGD, W2, b2 = gradient_descent(W_SGD, b_SGD, dropout_rate=.3, lbd =.03, learning_rate=0.03, signSGD = False)
if(rank==0):
